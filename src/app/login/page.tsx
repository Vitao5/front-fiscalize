  ...
  return (
    ...
    >
      ...
      <div className="relative flex flex-col items-center px-4 w-full max-w-[440px]">
        ...
        >
          <h1 className="text-2xl font-bold text-gray-900 mb-3">Bem-vindo de volta</h1>
          <p className="text-sm font-bold text-gray-600 mb-7">Entre na sua conta para continuar</p>
          ...
          <form className="space-y-5" action={formAction}>
            ...
            <div className="text-right">
              <Link href="/reset-password" className="text-sm text-primary-600 hover:text-primary-500 transition-colors">
                Esqueci a senha
              </Link>
            </div>
